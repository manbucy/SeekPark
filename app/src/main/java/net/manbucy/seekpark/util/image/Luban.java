package net.manbucy.seekpark.util.image;
...
import static net.manbucy.seekpark.util.image.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private static String DEFAULT_DISK_CACHE_DIR = "park_img";
